...
6. List the roles it plays. Each role MUST cite its evidence mentally from ABI/entities/dataSources; if the only evidence is the standard ERC-20 set, the honest role list is just "fungible token". Use confidence "low" for guesses, "high" only for evidence-backed roles.
